...
#define	  LIMIT_V	(10)
  cmnd VctrBody_V [ ] = {  /* body of the Long Vector V */
	cmd_GETADR, //  global data GetAdr operation
//  cmd_VCTRV -->
 	VARTELO,
	cmd_VCTRTYPE,	// pointer to VCTR Type descriptor
...
//  cmd_VCTRW -->
	...
	cmd_WVARTYPE	// pointer to WVAR Type descriptor
 };
...
//  cmd_VCTRBV -->
	...
	cmd_BVARTYPE	// pointer to BVAR Type descriptor
 };
