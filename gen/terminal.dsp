...
ACT VAR TRB'
ACT VAR TRB''
:  OS1 [for 9X] '' TRB'1 ! TRB' '' TRB''1 ! TRB'' ;
:  OS0 [for NT] '' TRB'0 ! TRB' '' TRB''0 ! TRB'' ;
:: : TUNE OS? BR+ OS1 OS0 ;
[]
0 %IF [Old variant]
ACT VAR TRB'
...
'' ITEE ! ITE
 ...
 B16 [ Средства поэкранного вывода ]
     ...
     [        в стандартной конфигурации ДССП она
...
1 %IF [::] : TTI [] [KEYPR] TTIN SGN [1/0] ; %FI
...
:: : .IC [] RCP [I,J] SpAtr ChPel [I,J,code,attr]
     ...
     1 %IF [т.к. ДССП-ваpиант пpоцедуpы ChPel pаботает слишком
...
: TON2 [N] 12 / [1/0,OST] #0 + E2 C BR0 D TOND  TOB'' SP [] ;
: TOND #0 + TOB'' ;
 '' T.. ! TOSIS 
