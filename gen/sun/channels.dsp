B16 
CR ."File system. Channels. Driver of printer." CR 
...
[::] : CONNECT [A,L] GTP !AFM CLRCH Sconnect [] ; 
     PBIT CONNECT 
: CLRCH [] AFM 2+ 0 MLPATHNAME DO CLRCH1 DD [] ; 
    : CLRCH1 [a,i] C2 C2 + 0 E2 !TB 1+ [a,i+1] ; 
...
: FS_M1 [] 
     ...
     K_FS_M BR 
           2 ."File not found" 
           3 ."Catalog not found" [ALPNF] [."Каталог не найден"] 
           4 ."It is too much open channels" 
           6 ."Channel is not open" 
          11 ."No device" 
          13 ."Write-protected disk" 
          14 ."Bad disk unit" 
          15 ."Device is not ready" 
          50 ."File already exist" 
         101 ."End of file" 
             ELSE FS_M2 EXERR [] ; 
: FS_M2 [] ."Error FileSys N" K_FS_M .B10 D [] ; 
...
%FI 
     ...
     : NOPL DD CR ."Not enogth memory!" 0 FS_MIST ; 
...
[::] : RENF [] ON ZAPROS ." in " CIWD 
               ON ZAPROS ." from " CIWD CONNECT CH2 REN CH2 ; 
