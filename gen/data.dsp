...
B10
CR ." СТРУКТУРЫ ДАННЫХ  ДССП/c i80386"
...
[::] : VAR [] DTYPE [TypePtr] TstDTYPE BR0 ERDTYPE VARF1 [] ;
     : ERDTYPE [] CR ."Неверный тип данных!" WRD SLOVO DSINIT EXERR [] ;
...
[::] : STRING [n] TSTRING STRF1 [] ;
     : STRF1 [n,''BSTR@] ADRMODE [AdrProc] ,L CODE ,VARBODY [n] 1+ C 4+ [n,lb] 
       3+ 0FFFFFFFC &  LOCATE [n,a] ,L ,L  DSINIT [] ;
B10
%FI
...
[::] : ;STRUCT
   ...
   RELCNT ,L [block size - длина структуры ] 
   NB [ запомним 'StructDesc - ук-ль дескриптора формируемой структуры ] 
   TSTRUCT TSTRUCTlen 4 * [AdrStruct,len (13*4)] 
...
: S(2 [A1,A,QW,''nextword] @R [A1,A,QW,''nw,A2] E4 E3 E2
      ...
      * C2 C2 [A1,A2,A,QW,''nextword,adata,size*dim,adata,s*d]
      ...
      E2 !R [полный ДССП-адрес в стек возвратов]
