...
//var 
long platformv,nomredv,nomverv,beg_yd1v,end_yd1v,beg_wd1v,end_wd1v,csbv,opsbv; 
...
{ VOC("LOAD",load); 
  ...
  VOC("__",sets); 
  VOC("CR",cr); 
  VOC("PLATFORMSET",platformset);
  VOC("PLATFORM",platform);
  platformv=1;
...
{ 
        ...
        {  
                ...
                {wd1=ptr1+q; ptr1=ptr1-wds0+(unsigned char*)beg_wd1v;} 
        return (void*)(ptr1); 
} 
...
*/
    ...
    /*    if (*(pdata)==__vctrpv) data_adr+=4;  */
        ...
        { 
                ...
                if (((long)data_adr>=beg_wd1v)&&((long)data_adr<end_wd1v))  
                        {       ptrd=(long*)(data_adr-(unsigned char*)beg_wd1v+wds0); break;    } 
...
void typeptr() 
{ 
        printf("v1=%ld, nv=%ld, nb=%ld, yd1=%ld, wd1=%ld, d1=%ld\n", 
                    v1-vs0,nv-vs0,nb-memory,yd1-sds0+beg_yd1v,wd1-wds0+beg_wd1v,d1); 
} 
...
{ 
        ...
        setv_sp("YD1"); // ! YD1 
        st_op[++opsp]=(long)(wd1-wds0+beg_wd1v); 
        setv_sp("WD1"); // ! WD1 
        st_op[++opsp]=(long)(d1); 
        setv_sp("D1"); // ! D1 
        st_op[++opsp]=(long)(nb-memory); 
        ...
        st_op[++opsp]=01;   // [Hомеp платоpмы генеpации: 1-IBM PC 2-SUN 3-LINUX 4-R3000]
        setv_sp("PLATFORM");// ! PLATFORM
        st_op[++opsp]=csbv; 
        ba=kk_sp("ARSB"); 
